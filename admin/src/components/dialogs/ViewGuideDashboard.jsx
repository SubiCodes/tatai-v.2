...
function ViewGuideDashboard({ isOpen, onClose, guide }) {

    const { updatingStatus, updateGuideStatus, deleteGuide, deletingGuide } = useGuideStore();
    const { getGuideById } = useDashboardStore()
...
export default ViewGuideDashboard