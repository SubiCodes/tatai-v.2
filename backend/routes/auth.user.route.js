...
import { validateUserAccess, resendVerificationToken, resetPassword, sendResetPasswordToken, signIn, verifyResetPassword, verifyUser, changePassword } from "../controllers/auth.user.controller.js";
...
authUserRouter.post("/change-password/:id", changePassword);
